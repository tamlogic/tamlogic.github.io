...
const environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyB-l7tv94YGGxqAs16pXdF3i5ozr6tn5G8',
        authDomain: 'english-demo-071098.firebaseapp.com',
        databaseURL: 'https://english-demo-071098-default-rtdb.asia-southeast1.firebasedatabase.app',
        projectId: 'english-demo-071098',
        storageBucket: 'english-demo-071098.appspot.com',
        messagingSenderId: '785987358605',
        appId: '1:785987358605:web:cd403939360b131aa1b7c4',
        measurementId: 'G-RZ4430F3NR'
    }
};
...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'base',
                loadChildren: () => Promise.all(/*! import() | views-base-base-module */[__webpack_require__.e("default~views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-p~86b67071"), __webpack_require__.e("default~views-base-base-module~views-product-product-module"), __webpack_require__.e("views-base-base-module")]).then(__webpack_require__.bind(null, /*! ./views/base/base.module */ "Cvcy")).then(m => m.BaseModule)
            },
            {
                path: 'buttons',
                loadChildren: () => Promise.all(/*! import() | views-buttons-buttons-module */[__webpack_require__.e("default~views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-p~86b67071"), __webpack_require__.e("views-buttons-buttons-module")]).then(__webpack_require__.bind(null, /*! ./views/buttons/buttons.module */ "Reju")).then(m => m.ButtonsModule)
            },
            {
                path: 'charts',
            ...
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() | views-dashboard-dashboard-module */[__webpack_require__.e("default~views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-p~86b67071"), __webpack_require__.e("default~views-dashboard-dashboard-module~views-theme-theme-module~views-widgets-widgets-module"), __webpack_require__.e("common"), __webpack_require__.e("views-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./views/dashboard/dashboard.module */ "6dU7")).then(m => m.DashboardModule)
            },
            {
                path: 'icons',
            ...
            {
                path: 'product',
                loadChildren: () => Promise.all(/*! import() | views-product-product-module */[__webpack_require__.e("default~views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-p~86b67071"), __webpack_require__.e("default~views-base-base-module~views-product-product-module"), __webpack_require__.e("views-product-product-module")]).then(__webpack_require__.bind(null, /*! ./views/product/product.module */ "P9i9")).then(m => m.ProductModule)
            },
            {
                path: 'theme',
