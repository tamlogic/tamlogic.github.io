...
/* harmony import */ var _services_authenticate_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/authenticate.service */ "DtyL");
...
/* harmony import */ var md5__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! md5 */ "aCH8");
...
/* harmony import */ var xss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! xss */ "Xjjk");
...
let LoginComponent = class LoginComponent {
    ...
    signIn() {
        ...
        const thisGlobal = this;
        this.authService.signIn(this.handleXSS(this.email), this.handleXSS(md5__WEBPACK_IMPORTED_MODULE_9___default()(this.password)), () => {
            thisGlobal.router.navigate(['/product/lesson']);
            const expiryDate = new Date();
            console.log('user: ', this.authService.getAuthUser());
            expiryDate.setDate(expiryDate.getDate() + 7);
            this.cookieService.set('a_t', Object(uuid__WEBPACK_IMPORTED_MODULE_8__["v4"])(), { expires: expiryDate });
        });
    }
    handleXSS(source) {
...
LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_authenticate_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticateService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"],
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'product',
                loadChildren: () => Promise.all(/*! import() | views-product-product-module */[__webpack_require__.e("default~views-base-base-module~views-product-product-module"), __webpack_require__.e("views-product-product-module")]).then(__webpack_require__.bind(null, /*! ./views/product/product.module */ "P9i9")).then(m => m.ProductModule)
            },
            {
                path: 'theme',
